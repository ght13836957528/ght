...
public class MathEx
{
	...
	public static bool IsOutScreen(RectTransform target, Rect area, Transform canvas)
	{
		Bounds bounds = RectTransformUtility.CalculateRelativeRectTransformBounds(canvas, target);
	...
	/// <summary>
	/// 当CanvasScaler是ScaleWithScreenSize模式时的边界
	/// </summary>
	/// <param name="_canvasScaler"></param>
	/// <returns></returns>
	public static Rect ScaleWithScreenSizeRect(CanvasScaler _canvasScaler)
	{
