...
namespace AssetBundles
{
    ...
    public class AssetBundleLoadAssetOperationFull : AssetBundleLoadAssetOperation
    {
        ...
        {
            AssetBundles.AssetBundleManager.Log(AssetBundleManager.LogType.Info,"assetBundleName: " + assetBundleName  + "  assetBundleVariant:" + assetBundleVariant + "  assetName:" + assetName);
